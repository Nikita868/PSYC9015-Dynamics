%[t,x] = Forced_Ray_do(Pos, K, epsilon, beta, fw, stoptime, plotflag);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% M.J.Richardson 1/2007
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [t,x] = Forced_Rayleigh(Pos, k, epsilon, beta, fw, stoptime, plotflag)
...
[t,x]=ode45(@Forced_Ray_Sim,tspan,y0,options,k,epsilon,beta,fw);
...
function dxdt = Forced_Ray_Sim(t,y,k,epsilon,beta,fw)

%One line for each state:
dxdt =[ 
       y(2)
       -k^2*y(1)-epsilon*(((y(2)^2)-1)*y(2))+ beta*cos(y(3)*fw)
       1
];
